...
Since GSEA interpretation in `clusterProfiler` rely on ENTREZ IDs, we will filter out genes not annotated in ENTREZ:
...
Select gene log2(Fold Changes) and assign ENTREZ IDs as names of the vectors:
