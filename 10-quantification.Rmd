...
::: design
**Task 4**: How many genes were annotated?
:::

::: design
**Task 5**: What are the top 10 most expressed genes with defined annotation?
:::

::: design
**Task 6**: Given the information about the most expressed genes in the dataset, make a guess about the tissue type from which your reads were derived.
:::
